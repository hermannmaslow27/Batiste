  ...
  return (
    <div className="max-w-3xl">
      ...
      <div className="space-y-4">
        ...
        {/* ─── Général ─── */}
        <Card>
          <Collapsible title={t.settings.general} variant="card" defaultOpen>
            <div className="space-y-4">
              ...
              {/* Visibility inline here */}
              <Field label={t.settings.visibility} hint={t.settings.visibilityHelp}>
        ...
        {/* ─── Thème ─── */}
        <Card>
          <Collapsible title={t.settings.theme} variant="card" defaultOpen={false}>
        ...
        {/* ─── Langues ─── */}
        <Card>
          <Collapsible title={t.settings.languages} variant="card" defaultOpen={false}>
            <div className="space-y-4">
                        ...
                        onClick={() => {
                          ...
                          setForm({
                            ...
                            supportedLanguages: active
                              ? form.supportedLanguages.filter((v) => v !== code)
        ...
        {/* ─── SEO ─── */}
        <Card>
          <Collapsible title={t.settings.seo} variant="card" defaultOpen={false}>
            <div className="space-y-4">
        ...
        {/* ─── Fonctionnalités ─── */}
        <Card>
          <Collapsible title={t.settings.modules} variant="card" defaultOpen={false}>
            <p className="mb-4 text-[12.5px] text-zinc-500">{t.settings.modulesHelp}</p>
        ...
        {canDelete && (
          <Card className="border-red-200/80">
            <Collapsible
              ...
              defaultOpen={false}
            >
              <p className="mb-4 text-[12.5px] text-zinc-500">{t.settings.deleteSiteHelp}</p>
